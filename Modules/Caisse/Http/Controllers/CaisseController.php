...
namespace Modules\Caisse\Http\Controllers;
...
class CaisseController extends Controller
{
    ...
    {
        $caisses = Caisse::with('user')->with('person')->get();
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(),Caisse::$rules);
    ...
    {
        $caisse = Caisse::where('id',$id)->with('person')->first();
