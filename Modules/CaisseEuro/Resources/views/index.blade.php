...
@section('title', 'CaisseEuro')

@section('breadcrumbs')

    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">CaisseEuro</li>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">CaisseEuro page 🚀</h4>
            <div class="dt-buttons btn-group flex-wrap">
                <button class="btn add-new btn-primary mt-50" tabindex="0" aria-controls="DataTables_Table_0"
                        type="button" data-toggle="modal" data-target="#modals-slide-in-caisse" onclick="AddNewBonAchat()"><span>Add CaisseEuro</span>
                </button>
        ...
        <div class="card-body">
            ...
            <section id="basic-datatable">
                ...
                @include('caisseeuro::modals.archive')
                @include('caisseeuro::modals.create-edit')
    ...
    @push('js')
        ...
        <script>
               ...
               function AddNewBonAchat(){
                ...
                var url_store_caisse = '{{ route("caisseeuro.store") }}';
                ...
                var url_delete_caisse = '{{ route("caisseeuro.delete",":id") }}';
                ...
                var url_update_caisse = '{{ route("caisseeuro.update",":id") }}';
                ...
                $('#TitleModalCaisse').text("Edit CaisseEuro");
                $('#btn_submit_caisse').text("Save Changes");


                var url_update = '{{ route("caisseeuro.edit",":id") }}';
