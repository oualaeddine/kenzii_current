<section class="products-wrapper mt-10 pt-2 mb-6 pb-2">
    <div class="title-wrapper">
        ...
        <span class="title-info">Récemment arrivé</span>
    </div>
    <div class="container">
        <div class="row">
                        ...
                        <figure class="product-media">
                            <a href="{{route('dentaire_store.products',$item->product->slug)}}">
                              ...
                              {{--   <img src="{{ asset($item->product->main_photo->link) }}" alt="product" width="280" height="315" style="box-shadow:0 .5rem 1rem rgba(0,0,0,.15)!important;"> --}}
                                ...
                                {{-- <img src={{asset('dentaire/images/demos/demo-medical/products/9-1.jpg')}} alt="product" width="300"
                                    height="338">
                                <img src={{asset('dentaire/images/demos/demo-medical/products/9-2.jpg')}} alt="product" width="300"
                                    height="338"> --}}
                            </a>
