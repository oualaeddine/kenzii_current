<div class="d-inline-flex">
    ...
    <div class="dropdown-menu dropdown-menu-right" style="">
        <a href="javascript:;" class="dropdown-item" data-toggle="modal" data-target="#delete-payment-modal" onclick="DeletePayment({{$id}})">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
<a href="javascript:;" class="item-edit" data-toggle="modal" data-target="#modal-edit-payment" onclick="EditPayment({{$id}})">
