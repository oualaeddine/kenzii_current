...
class ShopController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       /*  if($request->search != null){
        ...
        return view('barbarostools::shop', compact('page_title','products','current_brand','categories','brands','category_selected','nbr_pages','sort_by','price_lower','price_upper','search'))->with('fb_pixel', $store->fb_pixel);
    }
