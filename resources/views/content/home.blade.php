...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="card-text">
                <p>
                    Getting start with your project custom requirements using a ready template which is quite difficult
                    and time
                ...
                <ul>
                    ...
                    <li>
                        Every components in Vuexy Admin are decoupled, it means use use only components you actually
                        need! Remove
        ...
        <div class="card-body">
            <div class="card-text">
                ...
                <ul>
                    ...
                    <li>
                        Select your choice of layout from starter kit, customize it with optional changes like colors
                        and branding,
