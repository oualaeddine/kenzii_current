    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            {{--  <li class="nav-item">
                  ...
                  <a href="javascript:;" class="btn btn-success" onclick="SmsModal()"><i class="far fa-comment-dots"></i> Send Sms</a>
              </li>--}}
            ...
            @if(isset($menuData[0]))
                @foreach($menuData[0]->menu as $menu)
                    ...
                    @foreach($menu->roles as $r)
                        @if(\Illuminate\Support\Facades\Auth::user()->hasRole($r))
                            @php
                                $canSee = true;
                            @endphp
                            @break
            ...
            <li class="nav-item">
                ...
                <a href="javascript:;" class="btn btn-success" onclick="EnterCharge()"><i class="fas fa-dollar-sign"></i>Add Charge</a>
            </li>
...
@push('js')
    <script>
        ...
        $('#Enter-Charge-model').appendTo("body").modal('show');
        }

        function SmsModal() {

            $('#Send-Sms-model').appendTo("body").modal('show');
        }
    </script>
