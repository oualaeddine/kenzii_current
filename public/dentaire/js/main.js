                ...
                $.ajax( {
                    ...
                    success: function ( result ) {
                        ...
                        setTimeout( function () {
                            ...
                            var next = loadCount + 1;
                            $this.attr("href", "/barbarostools/load_more/"+next );

                            // do not load more than 2 times
                            if($this.data('count') % 12 != 0){
                                var count = Math.floor($this.data('count') / 12) + 1;

                            }else{
                                var count = Math.floor($this.data('count') / 12);
                            }
                           
                            loadCount >= count && $this.hide();
